  ...
  const buyToken = async() => {
    ...
    if (!isConnected) {
      ...
      if (paymentAmount != "" && paymentAmount >= currentPrice) {
        ...
        alert(`Payment Amount less than ${currentPrice} ${payWith}`);
      }
    }
  };

  //add custom token to metamask
  const addTokenMetamask = () => {
    // console.log("addTokenMetamask clicked!!!!");
    if (
      ...
      window.ethereum
        .request({
          ...
          params: {
            type: "ERC20",
            options: {
              address: "0x1C07B56d1765D15Aa9d28C5e6cfe2cC2A765b27b",
              symbol: "REXX",
              decimals: 18, // Decimal value for your token
              image: "https://coinrexx.com/Rexx%20Logo.png", // Logo URL for your token
            },
          },
        })
        .then((success) => {
          if (success) {
            console.log("Rexx Coin has been added to MetaMask");
          } else {
                  ...
                  {isBuyNow ? (
                    ...
                    <div className="card-content">
                      ...
                      <div className="btn-container">
                        ...
                        <Button onClick={addTokenMetamask}>
                          Add Rexx Coin to MetaMask
                        </Button>
                      </div>
                    </div>
                  )}
